describe("Testing onet.pl", () => {
  beforeEach(() => {
    ...
    cy.get('[class^="cmp-button_button cmp-intro_acceptAll"]').should(
      "not.be.visible"
    );
  });
  ...
  it("should correctly search for a query", () => {
    ...
    cy.url().should(
      "include",
      "https://szukaj.onet.pl/wyniki/?qt=testowe+wyszukanie"
    );
  });
  ...
  it("should have correct names and links in the navbar", () => {
    const manuPositions = [
      ...
      {
        name: "Nieruchomości",
        link: "https://www.morizon.pl/?utm_source=Onet-RASP&utm_medium=link&utm_campaign=onet-nav",
      },
    ];
